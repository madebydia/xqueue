...
requires:
  ...
  runtime: python3
permissions:
  filesystem: read/write within xqueue/ directory (config, logs, tweet files)
  network: api.twitter.com, upload.twitter.com (posting tweets and media)
  keychain: optional macOS Keychain access if XQUEUE_KEYCHAIN_ACCOUNT is set (fallback for credentials)
---
